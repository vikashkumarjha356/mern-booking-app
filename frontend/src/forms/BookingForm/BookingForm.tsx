...
const BookingForm = ({ currentUser, paymentIntent }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onsubmit)}
            className="grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-5" action="">
            ...
            <div className="space-y-2">
                <h2 className="texl-xl font-semibold">Your Price Summary</h2>
            ...
            <div className="flex justify-end">
                <button type="submit" disabled={isLoading} className="bg-blue-600
                 text-white p-2 font-bold hover:bg-blue-500 text-md disabled:bg-gray-500">
